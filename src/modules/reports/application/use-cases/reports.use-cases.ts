...
@Injectable()
export class SendReportPdfEmailUseCase {
  constructor(private readonly reportMailService: ReportMailService) {}

  execute(payload: SendReportPdfEmailDto) {
    return this.reportMailService.sendReportPdfEmail(payload);
  }
}
